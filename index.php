        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="form-group">
                    <button type="submit" class="col-12 btn btn-danger btn-lg btn-block" tabindex="2">
                      LOG IN
                    </button>
                    <br/ >
                      <div class="form-group">
                    <button type="reset" class="col-12 btn btn-danger btn-lg btn-block" tabindex="2">
                      HAPUS
                    </button>
                  </div>
                </form>
            ...
            <div class="mt-5 text-muted text-center">
             ...
             <center><a href="faq.php">FAQ</a></center>
